...
export const metadata = {
  title: 'Dental Clinic Tour | Modern Dental Facility in Sector 65, Gurgaon | Hapliv Dental Clinic',
  description:
  ...
  openGraph: {
    title: 'Dental Clinic Tour | Hapliv Dental Clinic - Sector 65, Gurgaon',
    description:

...
function BlurImage({image}){
    ...
    return (
        <a className="group" href={href}>
            <div className="relative w-full overflow-hidden bg-gray-200 rounded-lg drop-shadow-lg" style={{ paddingBottom: '100%' }}>
                {hasError ? (
            ...
            {image.caption && (
                <h2 className="mt-4 text-xl font-extrabold text-center text-gray-700">
                    {image.caption}
                </h2>
            )}
        </a>

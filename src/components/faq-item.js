...
export default function FaqItem({ faq }) {
    return (
        ...
        // </article>
         ...
         {/* Questions */}
         <label htmlFor={faq.question} className="flex items-center text-xl font-bold text-left text-orange-600 basis-3/4 md:text-2xl question">Q. {faq.question}</label>
         <label htmlFor={faq.question} className="ml-2 absolute top-[30px] right-[10px] rotate-0 peer-checked:rotate-180 duration-200"><FaAngleDown></FaAngleDown></label>
...
export function AppointmentPageFAQItem({ faq }) {
    return (
        <div className="relative p-2 m-2 leading-8 text-left border card">
            <input type="checkbox" className="absolute opacity-0 peer" id={faq.question}></input>
            {/* Questions */}
            <label htmlFor={faq.question} className="flex items-center text-lg font-bold text-left text-primary basis-3/4 md:text-lg question">Q. {faq.question}</label>
            <label htmlFor={faq.question} className="ml-2 absolute top-[30px] right-[10px] rotate-0 peer-checked:rotate-180 duration-200"><FaAngleDown></FaAngleDown></label>

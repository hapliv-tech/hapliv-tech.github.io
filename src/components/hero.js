...
export default function Hero({ heading }) {
    ...
    return (
        <>
            <div className='flex items-center justify-center h-screen mb-12 md:bg-fixed bg-center bg-cover' style={{ backgroundImage: "url(" + `${bg.src}` + ")", backgroundSize: 'cover', backgroundClip: 'border-box' }}>
                ...
                <div className='absolute right-14 bottom-14 v-screen item-center p-5 text-white bg-black z-[2] mt-[10rem]'>
                    <p className='masked-copy texture-orange text-3xl font-extrabold' style={{ backgroundImage: "url("+`${texture_image.src}`+")"}}>{slogan}</p>
